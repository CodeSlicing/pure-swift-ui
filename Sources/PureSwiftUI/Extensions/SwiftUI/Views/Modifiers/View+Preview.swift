...
public enum PreviewDeviceName: String, CaseIterable {
    ...
    @available(*, obsoleted, renamed: "iPad_Pro_11_inch_1st_gen")
    case iPad_Pro_11_inch = "do not use"
    ...
    @available(*, obsoleted, renamed: "iPad_Pro_12_9_inch_1st_gen")
    case iPad_Pro_12_9_inch = "do not use"
